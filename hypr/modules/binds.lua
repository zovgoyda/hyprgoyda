...
hl.bind("ALT+ R", hl.dsp.exec_cmd("kitty"))
--local closeWindowBind = hl.bind(mainMod .. " + Q", hl.dsp.window.kill())

--hl.bind(mainMod .. " + Q", function()
--    local active_window = hl.get_active_window()
--
--    -- Исправлено на '==' для сравнения
--    if active_window and active_window.class == "noctalia" then
--        -- Обернуто в hl.dispatch для выполнения
--        hl.dispatch(hl.dsp.exec("noctalia msg panel-toggle settings"))
--    else
--        -- Обернуто в hl.dispatch для выполнения
...
local function safe_kill()
	local active_window = hl.get_active_window()
	if active_window and active_window.class == "dev.noctalia.Noctalia" then
		hl.dsp.exec_cmd("notify-send 'Зря'")
	else
		hl.dispatch(hl.dsp.window.close())
	end
end
hl.bind(mainMod .. " + Q", safe_kill)
